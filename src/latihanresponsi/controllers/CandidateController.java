...
public class CandidateController {
    ...
    private void addCandidate() {
        try {
            ...
            boolean success = dao.addCandidate(candidate);
            if (success) {
                JOptionPane.showMessageDialog(view, "Data Berhasil Ditambahkan!");
                clearForm();
                loadTableData();
            } else {
                JOptionPane.showMessageDialog(view, "Gagal menambahkan data. Periksa koneksi database.");
            }
    ...
    private void updateCandidate() {
        ...
        try {
            ...
            if (success) {
                ...
                JOptionPane.showMessageDialog(view, "Gagal mengubah data. Periksa koneksi database.");
            }
    ...
    private void deleteCandidate() {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            boolean success = dao.deleteCandidate(selectedId);
            if (success) {
                JOptionPane.showMessageDialog(view, "Data Berhasil Dihapus!");
                clearForm();
                loadTableData();
            } else {
                JOptionPane.showMessageDialog(view, "Gagal menghapus data. Periksa koneksi database.");
            }
        }
    }
